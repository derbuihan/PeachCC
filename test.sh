...
int add6(int a1, int a2, int a3, int a4, int a5, int a6) {return a1+a2+a3+a4+a5+a6;}
EOF
...
assert() {
  ...
  echo "$input" | ./peachcc -o tmp.s - || exit
...
assert 10 'int main() {return 2+2*4;}'
...
assert 96 'int main() {int a=1; int b=2; int c=3; int d=4; int e=5; int f=6; int g=7; int h=8; int i=9; int j=10; return j+i*h+(g+f)/(e-d)+c-b*a;}'
...
assert 5 'int main() {if (0) { if (0) {return 3;} else {return 4;}} else {return 5;} return 6; }'
assert 5 'int main() {if (0) { if (1) {return 3;} else {return 4;}} else {return 5;} return 6; }'
assert 4 'int main() {if (1) { if (0) {return 3;} else {return 4;}} else {return 5;} return 6; }'
assert 3 'int main() {if (1) { if (1) {return 3;} else {return 4;}} else {return 5;} return 6; }'
...
assert 55 'int main() {int i=0; int sum=0; while (i<10) {i = i+1; sum=sum+i;} return sum;}'
...
assert 5 'int main() {int x=3; int y=5; return (&x+2)-&x+3; }'
assert 2 'int main() {int x=11; return (&x+1)-(&x-1);}'

assert 11 'int main() {return ret11();}'
assert 33 'int main() {int a = ret11(); int b = ret22(); return a + b;}'
assert 33 'int main() {return add(11, 22);}'
assert 11 'int main() {return sub(22, 11);}'
assert 21 'int main() {return add6(1, 2, 3, 4, 5, 6);}'
assert 10 'int main() {return sub(add6(1, 2, 3, 4, 5, 6), 11);}'
...
assert 1 'int main() { return sub_char(7, 3, 3); } int sub_char(char x, char y, char z) { return x - y - z; }'
